...
('Cihampelas Walk', 'POINT(977 1228)', 'Mall', 'Jl. Cihampelas No 160'),
('Paris Van Java', 'POINT(850 1275)', 'Mall', 'Jl. Sukajadi no 137'),
('Museum Geologi', 'POINT(965 1261)', 'Museum', 'Jl. Diponegoro no 157'),
('Museum Sri Baduga', 'POINT(794 1302)', 'Museum', 'Jl. BKR no 185'),
('Stadion Siliwangi', 'POINT(900 1819)', 'Olahraga', 'Jl. Lombok no 10'),
('Gedung Merdeka dan Museum KAA', 'POINT(225 376)', 'GedungTua', 'Jl. Asia Afrika'),
('Gor Pajajaran', 'POINT(632 1856)', 'Olahraga', 'Jl. Pajajaran no 37'),
('Saung Angklung Udjo', 'POINT(1687 1145)', 'Budaya', 'Jln. Padasuka 118 Kota Bandung'),
('Dago Endah Golf', 'POINT(959 2413)', 'Olahraga', 'Jl. Lapangan Golf Dago no 78');